...
def telethon_session():
    ...
    # logging in
    try:
        with TelegramClient(StringSession(), API_ID, API_HASH) as UNIKS:
            print("Generating a string session for •UNIKS•")
            try:
                ult = UNIKS.send_message(
                    "me",
        ...
        print(er)
        print("If you think It as a Bug, Report to @UNIKSSupport.\n\n")
