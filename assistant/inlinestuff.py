...
async def repo(e):
    ...
    await e.answer(res, switch_pm="UNIKS Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://telegra.ph/UNIKS-09-01-6)',
        )
    ...
    try:
        ...
        return await ult.answer(
            [
                await ult.builder.article(
                    title="How to Use?",
                    description="Tl Searcher by UNIKS",
                    url="https://t.me/TheUNIKS",
                    text=text,
                )
            ],
            switch_pm="Tl Search 🔍",
