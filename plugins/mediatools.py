...
async def mi(e):
    ...
    url = await make_html_telegraph("Mediainfo", "UNIKS", f"<code>{murl}</code>")
    ...
    try:
        urll = await make_html_telegraph("Mediainfo", "UNIKS", out)
