...
from . import HNDLR, LOGS, asst, con, get_string, mediainfo, os, types, udB, UNIKS_cmd
...
@UNIKS_cmd(pattern="unbanall$", manager=True, admins_only=True, require="ban_users")
async def _(event):
