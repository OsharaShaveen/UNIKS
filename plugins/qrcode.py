...
from . import get_string, UNIKS_bot, UNIKS_cmd


@UNIKS_cmd(pattern="qrcode( (.*)|$)")
async def cd(e):
    ...
    pfp = await e.client.get_profile_photos(UNIKS_bot.uid)
    img = "resources/extras/teamUNIKS.jpg"
    if len(pfp) >= 1:
